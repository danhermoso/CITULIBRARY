...
<section id="recent-posts" class="recent-posts">
    <div class="container section-title" data-aos="fade-up">
        ...
        <p>Discover the latest updates on new book arrivals, upcoming events, and library services tailored for our university community!</p>
    </div>

    <div class="container">
    <a href="whatsnewdetail.php">
        <div class="row gy-4">
            <?php
            while ($row = $result->fetch_assoc()) {
              echo '<div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">';
              echo '<a href="whatsnewdetail.php?id=' . $row['id'] . '" class="container-link">'; // Opening anchor tag
              echo '<article>';
              echo '<div class="post-img">';
              // Assuming you have an 'image' column in your database
              echo '<img src="whatsnew/' . $row['image_link'] . '" alt="" class="img-fluid">';
              echo '</div>';
              echo '<p class="post-category" style="color: orange;">' . $row['name'] . '</p></a>'; // Change color to blue
              echo '<h2 class="title"><a style="color: maroon;">' . $row['description'] . '</a></h2>'; // Change color to green
              echo '<div class="d-flex align-items-center">';
              echo '<div class="post-meta">';
              echo '<p class="post-date"><time>' . $row['date_created'] . '</time></p>';
              echo '</div>';
              echo '</div>';
              echo '</article>';
              echo '</div>';
