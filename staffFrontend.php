...
/* display post or new */
  $sql = "SELECT staff_table.id,
                 staff_table.name, 
                 staff_table.position, 
                 staff_table.profile_link, 
                 staff_table.date_created
              FROM staff_table
              LEFT JOIN users ON users.id = staff_table.user_id
              ORDER BY staff_table.id DESC";
  ...
  <div class="container">
    <div class="row justify-content-center"> <!-- Center the row -->
        <div class="col-md-8"> <!-- Adjust the column width as needed -->
            <div class="row gy-4"> <!-- Remove text-center class -->
                <?php
                ...
                if ($result) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      echo '<div class="col-xl-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="100" style="text-align: center;">'; // Added mb-4 class for margin-bottom
