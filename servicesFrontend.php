...
/* display post or new */
  $sql = "SELECT service_table.id,
                 service_table.title, 
                 service_table.description, 
                 service_table.pic_link, 
                 service_table.date_created
              FROM service_table
              LEFT JOIN users ON users.id = service_table.user_id
        ...
        <div class="row gy-4">
            ...
            if ($result) {
              ...
              while ($row = $result->fetch_assoc()) {
               ...
               echo '<div class="post-img" style="text-align: center;">';
