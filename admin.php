    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10">
              ...
              <span style="font-size: 100px;">L</span>earning <br>
              <span style="font-size: 100px;">R</span>esource & <br>
              <span style="font-size: 100px;">A</span>ctivity <br>
              <span style="font-size: 100px;">C</span>enter <br>
            </h2>
          </div>
      </div>
    </div>
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="row align-items-xl-center gy-4">
      ...
      <div class="col-xl-12">
        <div class="icon-box brief-history-box" data-aos="fade-up" data-aos-delay="100">
          ...
          <p style='word-wrap: break-word; overflow: hidden;  text-overflow: ellipsis; text-align: justify; font-size: 15px;'>In 1946, approximately following the conclusion of World War II, the Cebu Institute of Technology opened its doors as an educational institution on F. Ramos Street, Cebu City. This endeavor was brought to fruition through the visionary efforts of its founder, Dr. Nicolas G. Escario, a physician who collaborated with the three distinguished technocrats: Engr. Fidel Dagatani, Engr. Amancio Alcordo and Engr. Jose A. Cavan. The institution’s inception was marked by the utilization of two prefabricated structures, with the library being improvised from a war damaged residential concrete structure’s living room. In the 1960’s CIT underwent a significant transition, relocating to a new campus on N. Bacalso Ave., a move that also involved the transfer of the library to its new location. In late1978, during the presidency of Don Rodolfo Lizares, Sr., a one- storey library building was constructed as part of a multi-million campus- wide development project in collaboration with EDPITAF (Educational Development Projects Implementing Task Force, Philippines). This project led to the library’s present location. In 2004, a major renovation of the college library was undertaken under the leadership of President Gregorio L. Escario who served as the third President of CIT and the first President of CIT-University. The renovated library underwent a transformation from its previous dull and dark gray appearance to a warm, cozy, and visually pleasing ochre ambiance. To enhance its suitability as a study environment, air-conditioning units were installed, and library operations were modernized through the implementation of a custom-built library management system. Furthermore, computers for the electronic catalog were seamlessly integrated using wireless technology. An Internet Center was also added. In line with staying current and adapting to contemporary educational needs, the library underwent a transformation into a Learning Resource and Activity Center. This renovation embraced the concept of a learning common, aiming to inspire learners toward innovation and excellence. With this redesigned space various learning areas were introduced, including discussion rooms, collaborative rooms, an activity loft, a pitch room, an activity center, a student’s lounge, and a multimedia viewing room.</p>
        </div>
      </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="icon-box">
        ...
        <p style='text-align: justify; font-size: 15px;'>To become the premier facilitator in bridging the gap between the vast array of information resources housed within our library and the diverse and evolving needs of contemporary knowledge seekers in the 21st century.</p>ges 
      </div>
    </div> <!-- End Vision Box -->
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
      <div class="icon-box">
        ...
        <p style='text-align: justify; font-size: 15px;'>To empower individuals with the tools, resources, and support necessary to navigate and harness the wealth of information available, thus fostering lifelong learning, critical thinking, and academic success in the ever-evolving landscape of the 21st century.</p>
      </div>
    </div> <!-- End Mission Box -->
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="500">
      <div class="icon-box">
        ...
        <p style='text-align: justify; font-size: 15px;'>
          The Library and Learning Resource Center is open every
          Monday to Friday 7:30 AM–7:30 PM
          Saturday 8:00 AM–12:00 PM Saturdays before scheduled major exams (prelim, midterm, pre-final & final exams) 8:00 AM–4:00 PM.<br>
          See you teknoys! 
        </p>
      </div>
...
<section id="stats" class="stats">
    <?php
        ...
        foreach ($files as $file) {
            $filePath = $dir . $file;
            if (is_file($filePath)) {
                // Assuming you want to display the first image in the directory
